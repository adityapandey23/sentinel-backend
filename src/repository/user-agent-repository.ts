...
export interface UserAgentRepository {
  create(data: NewUserAgent, tx?: DbOrTransaction): Promise<UserAgent | undefined>;
  findById(id: string, tx?: DbOrTransaction): Promise<UserAgent | undefined>;
  update(id: string, data: Partial<NewUserAgent>, tx?: DbOrTransaction): Promise<UserAgent | undefined>;
